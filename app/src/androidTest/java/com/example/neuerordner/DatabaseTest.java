...
public class DatabaseTest {
    ...
    public void insertion(int locationSize, int itemSize) {
        ...
        try {
            _dbService.InsertIntoDatabase(locationItems);
    ...
    public void testInsertEmptyMap() {
        try {
            _dbService.InsertIntoDatabase(new HashMap<>());
        } catch (Exception e) {
            fail("InsertIntoDatabase sollte bei leerer Map keine Exception werfen");
        }
    ...
    public void testInsertThousandEntries() {
        ...
        try {
            _dbService.InsertIntoDatabase(locationItemsMap);
        } catch (Exception e) {
    ...
    public void testUpdateExistingItem() {
        ...
        try {
            _dbService.InsertIntoDatabase(itemLocation);
        } catch (Exception e) {
